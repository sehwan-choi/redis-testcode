...
@SpringBootTest
@SpringBootApplication(scanBasePackages = "com.example.demo.concurrency.lock.redisson_lock")
@Import(RedisConfig.class)
@Slf4j
public class TestMain {

    private static final String STOCK_KEY = "redisson_stock";

    @Autowired
    RedisRepository redisRepository;

    @Autowired
    RedissonStockServiceFacade facade;
